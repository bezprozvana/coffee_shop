...
<div class="max-w-xl mx-auto py-8">
    <h2 class="text-2xl font-bold mb-6 text-gray-800 text-center w-full">Редагувати бренд</h2>
    
    <form action="{{ route('admin.brands.update', $brand) }}" method="POST" class="space-y-6 bg-white p-6 rounded-lg shadow">
        @csrf
        @method('PUT')
