...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex justify-between items-center mb-8">
            ...
            <h2 class="text-2xl font-bold text-gray-800">Список кавових продуктів</h2>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Вага</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <a href="{{ route('admin.products.show', $product) }}" class="hover:underline text-blue-600">
                                    {{ $product->name }}
                                </a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $product->price }} грн</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $product->weight->value ?? '—' }}</td>
                                ...
                                <div class="flex space-x-3">
                                    ...
                                    <form action="{{ route('admin.products.destroy', $product) }}" method="POST" class="inline">
                                        ...
                                        <button type="submit" 
                                                ...
                                                title="Видалити"
                                                onclick="return confirm('Видалити продукт?')">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
