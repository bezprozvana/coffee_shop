...
<div class="max-w-xl mx-auto py-8">
    <h2 class="text-2xl font-bold mb-6 text-gray-800 text-center w-full">Редагувати категорію</h2>
    ...
    <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="space-y-6 bg-white p-6 rounded-lg shadow">
        ...
        <div>
            <label for="name" class="block text-sm font-medium text-gray-700">Назва категорії</label>
        ...
        <div class="flex justify-end">
            <a href="{{ route('admin.categories.index') }}" class="text-gray-600 hover:underline mr-4">Скасувати</a>
            <button type="submit"
